...
@section('content')
    ...
    <style>
        ...
        <section class="main-slider">
            <div class="swiper-container thm-swiper__slider d-none" data-swiper-options='{
                      "slidesPerView": 1,
                      "loop": true,
                      "effect": "fade",
                      "autoplay": {
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" id="main_slider">
                        <div class="image-layer" style="background-image: url({{asset($item->image_path)}});"></div>
                        <!-- /.image-layer -->
                        <div class="container" style="margin-top: -80px">
                            <div class="row justify-content-around align-items-center">

                                
                                {{-- <div class="col-6 text-center mb-5 p-0 d-block d-lg-none">

                                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                               <a href="{{ route('calculator') }}" class="btn btn-light p-3">{{ AcTitle('kistihisab_calculator') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('details', '2') }}" class="btn btn-light p-3">{{ AcTitle('personal_loan') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('details', '3') }}" class="btn btn-light p-3">{{ AcTitle('business_loan') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('details', '4') }}" class="btn btn-light p-3">{{ AcTitle('account_opening') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('details', '5') }}" class="btn btn-light p-3">{{ AcTitle('home_loan') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('details', '6') }}" class="btn btn-light p-3">{{ AcTitle('study_loan') }}</a>
                                            </div>

                                            <div class="carousel-item">
                                               <a href="{{ route('contact') }}" class="btn btn-light p-3">{{ AcTitle('support') }}</a>
                                            </div>
                                            
                                            
                                        </div>
                                        <a role="button" class="carousel-control-prev" data-target="#carouselExampleControls" data-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        </a>
                                        <a role="button" class="carousel-control-next" data-target="#carouselExampleControls" data-slide="next">
                                ...
                                <div class="col-lg-4">
                                    {{-- <p>{{ __('message.slide_intro_text') }}</p>
                                    <h2> {{ (session('langCode') == 'en') ? $item->title : $item->title_in_bangla }} </h2>
                                    <a href="{{ route('contact') }}" class=" thm-btn"> {{ __("message.apply_for_loan") }} </a>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url({{asset('frontend/images/main-slider/main-slider-1-2.jpg')}});"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <p>{{ __('message.slide_intro_text') }}</p>
                                    <h2> {{ __('message.slide_title') }} </h2>
                                    <a href="javascript::" class=" thm-btn"> {{ __("message.apply_for_loan") }} </a>
                                    <!-- /.thm-btn dynamic-radius -->
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url(frontend/images/main-slider/main-slider-1-1.jpg);"></div>
                        <!-- /.image-layer -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
        ...
        {{-- <section class="about-one d-none">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-xl-7">
                        <div class="about-one__content">
                            <div class="block-title text-left">
                                <p> {{ __('message.company_intro') }} </p>
                                <h2>{{ __('message.company_intro_title') }}</h2>
                            </div><!-- /.block-title -->
                            <p>
                                {{ __('message.company_intro_body') }}
                            </p>
                                ...
                                <div class="feature-four__box text-left"><!-- .feature-four__box -->
                                    ...
                                    <div class="feature-four__box-icon"><i class="flaticon flaticon-property-1"></i></div>
                                        <div class="feature-four__box-right">
                                            <h3>
                                                {{ __('message.award_winning') }}
                                            </h3>
                                            <p> {{ __('message.award_winning_text') }} </p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="feature-four__box text-left"><!-- .feature-four__box -->
                                    ...
                                    <div class="feature-four__box-icon"><i class="flaticon flaticon-growth-1"></i></div>
                                        <div class="feature-four__box-right">
                                            <h3>                                        
                                                {{ __('message.certified_company') }}
                                            </h3>
                                            <p> {{ __('message.certified_company_text') }} </p>
                                        </div>
                                    </div>
                                </div><!-- /.feature-four__box -->
                            </div>
                    ...
                    <div class="col-lg-12 col-xl-5 d-none d-lg-block">
                        <form action="#" class="about-one__form wow fadeInUp">
                            <h3>{{ __('message.how_much_you_need') }}</h3>
                            <div class="about-one__form-content">
                                ...
                                <div class="mb-4">
                                    <label for="">Loan Period</label>
                                    <div class="input-group">
                                        <input type="number" name="period" id="period" class="form-control" value="1" onkeyup="calculator()">
                                        <span class="input-group-text">Years</span>
                                    </div>
                                </div>
                                ...
                                <a href="{{ route('contact') }}" class="thm-btn">{{ Translate('Apply For Loan') }}</a>
                            </div><!-- /.about-one__from-content -->
                        </form><!-- /.about-one__form -->
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
        ...
        <section class="service-one">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @endforelse
                    <a href="{{ route('story') }}" style="border-radius: 15px" class="mx-auto btn btn-outline-primary mt-5 py-2 px-5">Show More <i class="bi bi-arrow-right"></i> </a>
                </div><!-- /.row -->
            </div><!-- /.container -->
        </section><!-- /.service-one -->
