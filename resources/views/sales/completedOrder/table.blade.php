...
@section('page_title', 'Completed Order List')
   
@section('web-content')

<!-- page heading  -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="mb-0 text-gray-800 "> Completed Orders</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge bg-warning text-light">Completed</span>
                        @endif
                    </td>
                    <td>
                        <div class="d-inline-block dropdown">
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true"
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript::"
                                            onclick="if(confirm('Are you sure? you are changing the status of this record')){ location.replace('{{route('order.status', [$item->id, 3])}}'); }"
                                        >
                                            <i class="nav-link-icon fa fa-handshake"></i>
                                            <span>Delivered</span>
                                        </a>
