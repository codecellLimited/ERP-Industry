  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript::" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ __(env('APP_NAME')) }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->segment(2) == "category" || request()->segment(2) == "products") ? 'active' : '' }}">
              <i class="nav-icon fas bi bi-bag"></i>
              <p class="ml-2">
                Products
                <i class="right fas bi bi-caret-down"></i>
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.nanny.list') }}" class="nav-link {{ (request()->segment(2) == "nanny") ? 'active' : '' }}">
              <i class="nav-icon fas bi bi-person-circle"></i>
              <span class="ml-2">Nanny Services</span>
            </a>
          </li>
