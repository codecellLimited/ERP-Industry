...
class ServiceController extends Controller
{
    ...
    public function showList()
    {
        ...
        return view('admin.service.index')->with(compact('data'));
    }
    ...
    public function update(Request $request)
    {
        ...
        Service::find($key)->update($data);

       
        return to_route('admin.service.list')->with('success', 'Content updated successfully');
    }
